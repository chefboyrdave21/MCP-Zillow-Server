...
- `details`: In-depth implementation instructions and implementation log (Example: `"Use GitHub client ID/secret, handle callback, set session token.\n2024-06-01: Updated to use OAuth2."`)
- `testStrategy`: Verification approach (Example: `"Deploy and call endpoint to confirm 'Hello World' response."`)
- `subtasks`: List of smaller, more specific tasks that make up the main task (Example: `[{"id": 1, "title": "Configure OAuth", ...}]`)
- `completionNote`: (Optional) Final note on completion, lessons learned, or gotchas for future reference.
